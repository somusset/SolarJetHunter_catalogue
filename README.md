...
## In development
The notebook [from_SJH_catalog_to_ML_training_set](https://github.com/somusset/SolarJetHunter_catalogue/blob/main/from_SJH_catalog_to_ML_training_set.ipynb) expands on how to use the catalogue to produce a ML training set: the idea is to extract both a positive set from the catalogue of jets, and a negative set from the data that has been looked at by the volunteers and discarded as it did not contain any jets. Thorough testing of this notebook has not be done yet but it already contain useful information for anyone interested in using this catalogue as a training set. It supposes that you already know how to open the catalogue (see [SolarJetHunter_catalogue_tutorial](https://github.com/somusset/SolarJetHunter_catalogue/blob/main/SolarJetHunter_catalogue_tutorial.ipynb) ) and how to download data ([SolarJetHunter_download_cutouts](https://github.com/somusset/SolarJetHunter_catalogue/blob/main/SolarJetHunter_download_cutouts.ipynb)).
